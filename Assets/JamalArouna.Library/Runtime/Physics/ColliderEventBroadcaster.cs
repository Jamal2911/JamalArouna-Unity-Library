...
namespace JamalArouna.Library.Physics
{
    ...
    public sealed class ColliderEventBroadcaster : MonoBehaviour
    {
        ...
        public Collider[] GetOverlaps(int layerMask = UnityEngine.Physics.AllLayers, bool includeTriggers = true) =>
            PhysicsUtility.GetOverlaps(_collider, layerMask, includeTriggers);
    }   
}
